...
Where the first term can be seen as the within family variance, and the second as the between family variance. At equilibrium, where $V_1' = V_1$, $V_1$ is given by
